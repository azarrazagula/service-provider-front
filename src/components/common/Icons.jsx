...
// Lightweight, crisp SVG icons formatted cleanly
export const Stethoscope = ({ className = "w-6 h-6" }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
  ...
  >
    <path
      ...
      d="M11 2a2 2 0 00-2 2v5a2 2 0 002 2h2a2 2 0 002-2V4a2 2 0 00-2-2h-2zM4.5 9A3.5 3.5 0 008 12.5h8A3.5 3.5 0 0019.5 9M12 12.5V17a3 3 0 006 0v-1"
    />
...
export const ShieldCheck = ({ className = "w-6 h-6" }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const Loader2 = ({ className = "w-6 h-6" }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const EyeOff = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.018 10.018 0 013.972-.963c4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21M3 3l18 18"
    />
  </svg>
);

export const Phone = PhoneCall;
