        ...
        <div className="grid grid-cols-3 gap-2.5">
          {dateOptions.map((item) => (
            <button
              ...
              className={`p-3 rounded-2xl border text-center transition-all duration-200 ${selectedDate === item.label
            ...
            >
              ...
              <div
                className={`text-[10px] mt-0.5 font-normal ${selectedDate === item.label ? 'text-teal-100' : 'text-slate-500'
                  }`}
              >
                {item.subText}
              </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
          {timeSlots.map((slot) => (
            <button
              ...
              className={`p-2.5 rounded-xl border text-center transition-all duration-200 flex flex-col items-center justify-center ${selectedTime === slot.label
